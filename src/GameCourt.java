...
public class GameCourt extends JPanel {
    ...
    void tick() {
        if (playing) {
            ...
            if (snake.getHead().intersects(food)) {
                ...
                if(food instanceof AddThreeSnakeObjFood) {
                    score += 30;
                }
                snake.addOnePieceToSnake();
                spawnFood();
    ...
    public int getHighscore() throws IOException {
        ...
        try {
            File files = new File("highscore.txt");
            if (files.length() == 0) {
                highscore = 0;
                return highscore;
            }
            ...
            while (nextLine != null) {
                ...
                if (Integer.parseInt(arr[1]) > highscore) {
    ...
    public void writeHighScore() throws IOException {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, newLine, "Leaderboards", 1);
            reset();
