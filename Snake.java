...
public class Snake {
	...
	public void addOnePieceToSnake() {
	    //Create a new SnakeObj and add it to the end of the snake, at the position behind the 
	    //last currentSnakeObj in the snake
	    //If snakeList is empty, then add a new SnakeObj and set head = to that snakeObj, 
	    if(snakeList.size() == 0) {
	    ...
	    snakeList.addLast(new SnakeObj(newPoint));
	}
